...
export default function DemoMode({ demo, setDemo, setStudent, setEdit, setClickPassword, setPassword, setAdminPassword, setAdminEmail, setAuth, setIsResetting, setNewPassword, setSave, setCreated, setTitleClicked, setSaveRipple, setResetClicked, setEye, setHide, setUserEmail, setOpenModal, setResetTernary, textColor }) {
    return (
        <>
            {demo ? (
            <>
