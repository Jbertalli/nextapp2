            ...
            >
              <Grid.Column style={{ margin: '0em 0em .8em' }}>
                <div>
                  <h1>Services</h1>
                  <h3>
                    <Link href="/CalorieIntakeCalculator">
                      <a>Caloric Intake Calculator</a>
                    </Link>
                  </h3>
                  <h3>
                  ...
                  <h3>
                    <Link href="/BodyFatCalculator">
                      <a>Body Fat % Calculator</a>
                    </Link>
                  </h3>
                  <h3>
                  ...
                  <h3>
                    <Link href="/CompoundInterestCalculator">
                      <a>Compound Interest Calculator</a>
                    </Link>
                  </h3>
                </div>
              </Grid.Column>
              ...
              <Grid.Column>
                <div>
                  ...
                  <h3>
                    <Link href="/footer/privacy-policy">
                      <a>Privacy Policy</a>
                    </Link>
                  </h3>
                </div>
