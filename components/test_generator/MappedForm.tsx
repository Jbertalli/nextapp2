...
export default function MappedForm({ serviceList, save, student, finish, questionColor, handleQuestionChange, handleAnswerChange, handleStudentAnswerChange, handleServiceRemove, handleAddService }) {
    return (
        <>
            <div>
