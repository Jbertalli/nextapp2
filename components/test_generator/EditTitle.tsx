...
export default function EditTitle({ student, serviceList, save, setSave, setCreated, titleClicked, setTitleClicked, saveRipple, setServiceList, setOpenAnswerKey, setOpenQuestionKey, setOpenStudentAnswers, setName, setDate, setTitle, setDateClicked, setSecond, setTimed, setTimeClick, setOpenEmail, setUserEmail, setFinish, title, setNameClicked, questionColor }) {
    return (
        <>
            {!student ? (
            <>
