...
export default function ReturnAdminModal({ newModal, setNewModal, isResetting, setIsResetting, errorCheck, setErrorCheck, hide, setHide, eye, setEye, setResetTernary, resetTernary, sendResetEmail, setPassword, resetPassword, randomString, setResetPassword, setAdminPassword, setResetClicked, setShow, sameReset, resetMatch, setCreated, setStudent, setHideAdmin, setSave, setClickPassword, setAuth, resize, newPassword, setNewPassword, same, match }) {
    return (
        <>
            <Modal 
                dimmer
            ...
            >
                <div
                    ...
                    onClick={() => {setNewModal(false), setErrorCheck(false), setHide('password'), setEye(true), setResetTernary(false)}}
                >
                    x
                </div>
                {isResetting ? (
                <>
                    <div>
                        ...
                        >
                            ...
                            <>
                                <Button
                                    onClick={() => {sendResetEmail(), setPassword(resetPassword), setResetTernary(false)}}
                                    style={{
                            ...
                            <> 
                                <Button
                                    onClick={() => {randomString(20), setResetPassword(randomString(20)), setAdminPassword(''), setResetClicked(true), setResetTernary(true)}}
                                    style={{
