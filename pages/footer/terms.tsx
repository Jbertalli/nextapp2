    ...
    <>
      ...
      <Container style={{ margin: '3em 0 6em', fontSize: '17px' }}>
        ...
        <div className={styles.terms}>
          <h1 style={{ fontSize: desktop ? '48px' : '38px' }}>
            HealthStat Website Terms of Use
          </h1>
          <div style={{ fontSize: '21px' }}>Legal Information & Notices</div>
          <Icon
            name="file outline"
            size="massive"
            color="black"
        ...
        <div>
          ...
          <p>
            {`These terms and conditions outline the rules and regulations for the use of HealthStat's Website, located at`}{' '}
            <Link href="/" passHref>
              <u>
                <a style={{ color: '#3978f5' }} className={styles.hover}>
                  https://healthstat.com
                </a>
              </u>
            </Link>
          </p>
          ...
          <p>
            ...
            conditions. Do not continue to use HealthStat.com if you do not
          ...
          <p>
            Unless otherwise stated, HealthStat and/or its licensors own the
            intellectual property rights for all material on HealthStat.com. All
            intellectual property rights are reserved. You may access this from
            HealthStat.com for your own personal use subjected to restrictions
          ...
          <ul>
            <p>
              <li>Republish material from HealthStat.com</li>
            </p>
            <p>
              <li>Sell, rent or sub-license material from HealthStat.com</li>
            </p>
            <p>
              <li>Reproduce, duplicate or copy material from HealthStat.com</li>
            </p>
            <p>
              <li>Redistribute content from HealthStat.com</li>
            </p>
          </ul>
          ...
          <p>
            ...
            HealthStat does not filter, edit, publish or review Comments prior
            to their presence on the website. Comments do not reflect the views
            and opinions of HealthStat,its agents and/or affiliates. Comments
            reflect the views and opinions of the person who post their views
            and opinions. To the extent permitted by applicable laws, HealthStat
          ...
          <p>
            HealthStat reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant HealthStat a non-exclusive license to use,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of HealthStat;
          ...
          <p>
            ...
            sending an e-mail to HealthStat. Please include your name, your
